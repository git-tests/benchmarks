...
module fmc_tlu_discriminator_psu (vlatch, \vlatch*  );
// generated by  HDL Direct 16.3-S013 (v16-3-85Y) 7/19/2010
// on Mon Mar 28 11:20:20 2011
// from fmc_tlu_v1_lib/FMC_TLU_DISCRIMINATOR_PSU/sch_1
...
// begin instances 
  ...
  ferrite page1_i49  (.a(/* unconnected */),
	.b(/* unconnected */));

  inductance page1_i52  (.a(/* unconnected */),
	.b(/* unconnected */));
  defparam page1_i52.size = 1;

endmodule // fmc_tlu_discriminator_psu(sch_1) 
